...
<head>
    ...
    <?php
		...
		include $_SERVER['DOCUMENT_ROOT'].'\My Projects\EDC Website\backend-php\link.php';
...
<body class="deep-purple lighten-5" >
	...
	<div class="navbar">
		<nav>	
			...
			<div class="nav-wrapper deep-purple darken-5 z-depth-0">
	...
	<div class="deep-purple lighten-5 row">
						...
						<li>
							<div class="collapsible-header z-depth-4">
					      	...
					      	<div class="collapsible-body">
					      		<div class="section deep-purple lighten-4">
									<div class="row">
								...
								<div class="section purple lighten-4">
									<div class="row">
										<div class="col l10 offset-l1">
